...
/***/ function(module, exports, __webpack_require__) {
	...
	var sampleComponent = __webpack_require__(160);
	...
	var Motivate = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'button',
	      { onClick: this.motivate, style: { color: "blue", cursor: "pointer" } },
	      'Motiavate'
	    );
	  }
	});
	...
	var DutieContainer = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Greeting, { greeting: 'HeyB0ss' }),
	      React.createElement(DutiesList, { duties: duties }),
	      React.createElement(
	        SmallTip,
	        null,
	        React.createElement(
	        ...
	        React.createElement(Motivate, null)
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultBattleContainer = __webpack_require__(251);
	...
	var routes = React.createElement(
	  ...
	  React.createElement(
	    ...
	    React.createElement(Route, { path: '/results', component: ResultBattleContainer })
	  )
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Prompt = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      { className: 'jumbotron col-sm-6 col-sm-offset-3 text-center animated-cont', style: transparentBG },
	      React.createElement(
	        'h1',
	        null,
	        this.props.header
...
/***/ function(module, exports, __webpack_require__) {
	...
	var githubHelpers = __webpack_require__(228);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactRouter = __webpack_require__(162);
	var Link = ReactRouter.Link;
	var UserDetails = __webpack_require__(226);
	var UserDetailsWrapper = __webpack_require__(227);
	    ...
	    return this.props.isLoading === true ? React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          UserDetailsWrapper,
	          { header: 'Player 1' },
	          React.createElement(UserDetails, { info: this.props.playersInfo[0] })
	        ),
	        React.createElement(
	          UserDetailsWrapper,
	          { header: 'Player 2' },
	          React.createElement(UserDetails, { info: this.props.playersInfo[1] })
	        )
	      ),
	      React.createElement(
	        'div',
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { type: 'button', className: 'btn btn-lg btn-success', onClick: this.props.onInitiateBattle },
	            'Initiate Battle'
	          )
	        ),
	        React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultBattleContainer = React.createClass({
	  displayName: 'ResultBattleContainer',
